                            ...
                            <Card>
                                <CardContent>
                                    ...
                                    <Grid container spacing={1} alignItems="center">
                                        ...
                                        <Grid item xs={3}>
                                            <Button variant='outlined' color='success' sx={{marginLeft: '40px'}}
                                                    onClick={filterTransaction}>Filter</Button>
                                        </Grid>
                                    </Grid>
                                    <hr/>
                                    <Grid container>
                                ...
                                {listTransaction?.length <= 0 ? (
                                    ...
                                    >
                                                        ...
                                                        <Grid container spacing={2} sx={{pt: '4px'}}>
                                                            <Grid item xs={2}>
                                                                ...
                                                                <Avatar src={item.category_icon}
                                                                        sx={{mr: 0, width: '35px', height: '35px'}}/>
                                                            </Grid>
                                                        ...
                                                        <Grid container>
                                                            ...
                                                            <Grid item xs sx={{mt: '3px'}}>
                                                                ...
                                                                {item.category_type === 'income' ? (
                                                                    <Typography
                                                                        sx={{color: '#039BE5', marginBottom: 0}}>
                                                                        + {numberWithCommas(item.amount)}{' '}
                                                                        <span
                                                                            sx={{
                                                                                color: '#039BE5',
                                      ...
                                      đ
                                                                    ...
                                                                    <Typography
                                                                        sx={{color: '#E51C23', marginBottom: 0}}>
                                                                        - {numberWithCommas(item.amount)}{' '}
                                                                        <span
                                                                            sx={{
                                                                                color: '#E51C23',
